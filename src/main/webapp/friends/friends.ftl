...
<#macro content>
    ...
    <div class="flex justify-center items-center flex-col">
                ...
                <div class="text-pink-600 w-1/2 font-medium
                    ...
                    <div class="text-ml mx-3">
                        ...
                        <a href="/deleteFriend?id=${f.id}">
                            <button class="text-white rounded-md bg-pink-600 font-medium h-10 w-28 text-ml text-center" >
                                Delete friend
                            </button>
                        </a>
                    </div>
        ...
        <div>
            <a href="/addFriend">
                <button class="text-white rounded-md bg-pink-600 font-medium h-12 w-28 text-ml text-center" >
                    Add new friend
                </button>
            </a>
        </div>
