    ...
    <div class="flex items-center justify-center mt-32 flex-col">
        <form action="addFriend" method="post">
            ...
            <div class="font-medium text-pink-600 text-ml">
                Name:
                <input type="text" name="name" class="border border-pink-600
            ...
            <div class="font-medium text-pink-600 text-ml">
                Date of birth:
                <input type="date" id="dateOfBirth" name="dateOfBirth" class="border border-pink-600 bg-pink-50
            rounded-md"/>
            </div>
            <br>
            ...
            <div class="font-medium text-pink-600 text-ml">
                Zodiac sign:
                <input readonly type="text" id="zodiacSign" name="zodiacSign" class="border border-pink-600
            bg-pink-50 rounded-md"/>
            </div>
            <br>
            ...
            <div class="font-medium text-pink-600 text-ml">
                City:
                <input id="city" type="text" placeholder="city" name="city" class="border border-pink-600
            bg-pink-50 rounded-md"/>
            </div>

            <input type="submit" value="Add" class="text-white rounded-md bg-pink-600 font-medium h-12 w-24 mx-20
