...
<#macro content>
    ...
    <div class="flex justify-center mt-20">
        <form>
            <input type="button" id="ajax-button" value="Get daily phrase" class="text-white rounded-md bg-pink-600
            font-medium h-12 w-36 mx-20 my-14 text-ml text-center" />
        </form>
    </div>

    <div id="ajax-response" class="text-pink-600 w-full flex items-center justify-center font-medium text-xl mt-12 ">
